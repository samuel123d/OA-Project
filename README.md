...
| :--- | :--- |
| **Frontend** | HTML5, CSS3, JavaScript Avançado |
| **Multimédia** | Web Audio API (Trilha sonora e efeitos sonoros imersivos) |
| **Design** | Leonardo Phoenix (Assets de IA), Adobe Photoshop |
| **Metodologia** | Objeto de Aprendizagem (OA) Gamificado |
...
1. Efetue o clone do repositório:
   ```bash
   git clone [https://github.com/samuel123d/OA-Project.git](https://github.com/samuel123d/OA-Project.git)
